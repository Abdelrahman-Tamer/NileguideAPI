    ...
    public class ReviewService : IReviewService
    {
        ...
        public async Task<List<ReviewDto>> GetAllByActivityIdAsync(int activityId)
        {
            ...
            var reviews = await _context.Reviews
                ...
                .Select(x => new ReviewDto
                {
                    ...
                    CreatedDate = x.CreatedAt.ToString("d MMMM yyyy", CultureInfo.InvariantCulture)
                })
                .ToListAsync();
        ...
        public async Task<ReviewDto> CreateAsync(int activityId, int userId, CreateReviewDto dto)
        {
            ...
            return new ReviewDto
            {
                ...
                CreatedDate = review.CreatedAt.ToString("d MMMM yyyy", CultureInfo.InvariantCulture)
            };
        }
    }
}